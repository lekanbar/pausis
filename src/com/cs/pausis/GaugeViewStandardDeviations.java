...
public class GaugeViewStandardDeviations extends View {
	...
	public GaugeViewStandardDeviations(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		readAttrs(context, attrs, defStyle);
		init();
	}

	public GaugeViewStandardDeviations(final Context context, final AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public GaugeViewStandardDeviations(final Context context) {
		this(context, null, 0);
	}
	...
	public void setDefaultRanges() {
		mRangeValues = new float[] { 14.3f, 28.6f, 42.9f, 57.2f, 71.5f, 100.1f };
		mRangeColors = new int[]{ Color.rgb(231, 32, 43), Color.rgb(232, 111, 33), Color.rgb(232, 186, 33), Color.rgb(232, 231, 33), Color.rgb(5, 250, 107), Color.rgb(21, 176, 26) };
	}
