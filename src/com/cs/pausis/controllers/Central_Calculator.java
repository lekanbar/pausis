 ...
 *
 */
public class Central_Calculator extends AsyncTask<String, Integer, Drawable>
{
	private Drawable d;
    Context context;
     ...
     * @param pageType
     */
	public Central_Calculator(UserInputValues userInputValues, Context context, int pageType){
    ...
    protected Drawable doInBackground(String... args)
    {
        ...
        if (this.observedOvarianVolume != null) {
        	try{
				...
				ova.setObservedVolume(this.observedOvarianVolume.doubleValue());
