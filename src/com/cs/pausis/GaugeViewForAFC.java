...
public class GaugeViewForAFC extends View {
	...
	public GaugeViewForAFC(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);
		readAttrs(context, attrs, defStyle);
		init();
	}

	public GaugeViewForAFC(final Context context, final AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public GaugeViewForAFC(final Context context) {
		this(context, null, 0);
	}
